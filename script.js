...
const appendText = (label = "No label", placeholder = "No placeholder") => {
    ...
    deleteBtn.setAttribute('class', ' btn btn-danger btn-sm m-3')
...
const appendRadio = (label = "No label", placeholder = "No placeholder") => {
    let el = document.createElement("div")
     el.setAttribute("class", "my-2 p-4")
    let input = document.createElement("input")
    input.setAttribute("class", "mt-2 p-2")
    input.setAttribute("placeholder", placeholder)
    ...
    deleteButton.setAttribute('class', 'btn btn-outline-danger btn-sm m-4')
  ...
  const appendButton = (label = "No label", placeholder = "No placeholder") => {
    ...
    let input = document.createElement("input")
    input.setAttribute("class", "btn btn-primary mt-2")
    input.setAttribute("placeholder", placeholder)
    ...
    let deleteButton = document.createElement("button")
    deleteButton.textContent = "x";
    deleteButton.setAttribute('class', 'btn btn-danger btn-sm  m-5 ')
    deleteButton.addEventListener("click", () => {
      el.remove();
    });
